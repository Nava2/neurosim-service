function UnityProgress (dom) {
	...
	logoImage.src = "/static/img/Logo." + splashStyle + ".png"; 
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "/static/img/ProgressFrame." + splashStyle + ".png"; 
	...
	progressBarImg.src = "/static/img/ProgressBar." + splashStyle + ".png"; 
